...
<a href="{{ route('allow-domain-registration.show', $allowDomainRegistration) }}" class="btn btn-link text-decoration-none p-0 me-2">
{!! __('global.Details') !!}
</a>
<a href="{{ route('allow-domain-registration.edit', $allowDomainRegistration) }}" class="btn btn-link text-decoration-none p-0 me-2">
{!! __('global.Edit') !!}
</a>
@include('allow-domain-registration._delete_form', ['allowDomainRegistration' => $allowDomainRegistration])
</td>
</tr>
@empty
<tr>
