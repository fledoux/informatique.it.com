...
<div class="row g-3">
    <div class="col-12 col-lg-8">
        <x-forms.input name="name" :label="__('contact.fields.name')" :required="true" type="text" 
            :value="old('name', $contact->name ?? '')"
            placeholder="" />
    </div>
    <div class="col-12 col-lg-6">
        <x-forms.input name="email" :label="__('contact.fields.email')" :required="true" type="email" 
            :value="old('email', $contact->email ?? '')"
            placeholder="" />
    </div>
    <div class="col-12 col-lg-6">
        <x-forms.input name="phone" :label="__('contact.fields.phone')" :required="true" type="tel" 
