                ...
                @forelse($tickets as $ticket)
                    <tr>
                        ...
                        <td>
                            ...
                            @endswitch
                            <span
                                class="badge bg-{{ $badgeColor }}">{{ __('ticket.priority.' . $ticket->priority) }}</span>
                        </td>
                        ...
                        <td>{{ $ticket->assignedTo ? \App\Helpers\Helper::getFullName($ticket->assignedTo->firstname, $ticket->assignedTo->lastname, $ticket->assignedTo->name) : '—' }}</td>
                        <td>{{ $ticket->assigned_at ? ($ticket->assigned_at instanceof \Carbon\Carbon ? $ticket->assigned_at->format('d/m/Y H:i') : $ticket->assigned_at) : '—' }}
                        </td>
                        <td>{{ $ticket->due }}</td>
