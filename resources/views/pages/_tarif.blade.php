    ...
    <div class="container">
        ...
        <div class="row g-4 mt-4 align-items-stretch">
            <div class="col-md-12 col-lg-6">
                <div class="p-3 p-lg-4 bg-info border border-info bg-opacity-50 rounded-2 shadow-soft h-100 d-flex flex-column flex-md-row align-items-md-center justify-content-between">
                    <div class="me-md-3">
            ...
            <div class="col-md-12 col-lg-6">
                <div class="p-3 p-lg-4 bg-white bg-opacity-25 border border-orange rounded-2 h-100 d-flex flex-column justify-content-center gap-1 gap-sm-2">
        ...
        <div class="row g-4 mt-1">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="p-3 p-lg-4 bg-info border border-info bg-opacity-50 rounded-2 shadow-soft h-100 position-relative">
                    <span class="ribbon">
...
<section id="tarification" class="py-5 bg-light">
    <div class="container">
        ...
        <div
            ...
            <div class="col-lg-6">
                <div class="p-3 p-lg-4 bg-light border rounded-2 shadow-soft h-100">
