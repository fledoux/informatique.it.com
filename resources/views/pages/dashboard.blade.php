    ...
    <div class="row g-3 mb-5">
        ...
        <div class="col-12 col-md-4 col-xl-2">
            <div class="card shadow-sm h-100 {{ $ticketStats['open_tickets_count'] > 0 ? 'bg-danger text-white' : '' }}">
                <div class="card-body d-flex align-items-center gap-3">
                    <i class="fa-light fa-clipboard-list-check fs-3 {{ $ticketStats['open_tickets_count'] > 0 ? 'text-white' : 'text-orange' }}"></i>
                    <div>
        ...
        <div class="col-12 col-md-4 col-xl-2">
            <div class="card shadow-sm h-100 {{ $ticketStats['overdue_count'] > 0 ? 'bg-danger text-white' : '' }}">
                <div class="card-body d-flex align-items-center gap-3">
                    <i class="fa-light fa-triangle-exclamation fs-3 {{ $ticketStats['overdue_count'] > 0 ? 'text-white' : 'text-orange' }}"></i>
                    <div>
