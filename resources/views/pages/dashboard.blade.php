        ...
        <div class="col-12 col-md-4 col-xl-2">
            <div class="card shadow-sm h-100">
                <div class="card-body p-2 p-sm-3 d-flex align-items-center gap-1 gap-sm-3">
                    ...
                    <div>
                        <div class="text-uppercase small">{{ __('dashboard.KPI.Tickets') }}</div>
        ...
        <div class="col-12 col-md-4 col-xl-2">
            <div class="card shadow-sm h-100 {{ $ticketStats['open_tickets_count'] > 0 ? 'bg-danger text-white' : '' }}">
                <div class="card-body p-2 p-sm-3 d-flex align-items-center gap-1 gap-sm-3">
                    ...
                    <div>
                        <div class="text-uppercase small">{{ __('dashboard.KPI.Open') }}</div>
        ...
        <div class="col-12 col-md-4 col-xl-2">
            <div class="card shadow-sm h-100 {{ $ticketStats['waiting_count'] > 0 ? 'bg-warning' : '' }}">
                <div class="card-body p-2 p-sm-3 d-flex align-items-center gap-1 gap-sm-3">
                    ...
                    <div>
                        <div class="text-secondary small text-uppercase">{{ __('dashboard.KPI.Waiting') }}</div>
        ...
        <div class="col-12 col-md-4 col-xl-2">
            <div class="card shadow-sm h-100 {{ $ticketStats['overdue_count'] > 0 ? 'bg-danger text-white' : '' }}">
                <div class="card-body p-2 p-sm-3 d-flex align-items-center gap-1 gap-sm-3">
                    ...
                    <div>
                        <div class="text-uppercase small">{{ __('dashboard.KPI.Overdue') }}</div>
            ...
            <div class="col-12 col-md-4 col-xl-2">
                <div class="card shadow-sm h-100">
                    <div class="card-body p-2 p-sm-3 d-flex align-items-center gap-1 gap-sm-3">
                        ...
                        <div>
                            <div class="text-uppercase small">{{ __('dashboard.KPI.Contacts') }}</div>
            ...
            <div class="col-12 col-md-4 col-xl-2">
                <div class="card shadow-sm h-100">
                    <div class="card-body p-2 p-sm-3 d-flex align-items-center gap-1 gap-sm-3">
                        ...
                        <div>
                            <div class="text-uppercase small">{{ __('dashboard.KPI.Companies') }}</div>
