...
<aside class="bd-aside sticky-xl-top text-body-secondary align-self-start mb-3 mb-xl-5 px-2">
    ...
    <nav class="small" id="toc">
        <ul class="list-unstyled">
            <li class="my-2">
                <button type="button" class="btn d-inline-flex align-items-center border-0" data-bs-toggle="collapse" aria-expanded="true" data-bs-target="#contents-collapse" aria-controls="contents-collapse">Contents</button>
            ...
            <li class="my-2">
                <button type="button" class="btn d-inline-flex align-items-center border-0" data-bs-toggle="collapse" aria-expanded="true" data-bs-target="#forms-collapse" aria-controls="forms-collapse">Forms</button>
                <ul class="list-unstyled ps-3 collapse show" id="forms-collapse">
                    <li>
            ...
            <li class="my-2">
                ...
                <ul class="list-unstyled ps-3 collapse" id="components-collapse">
                    ...
                    <li>
                        <a class="d-inline-flex align-items-center rounded text-decoration-none" href="#navs-tabs">Navs & tabs</a>
                    </li>
                    <li>
                        <a class="d-inline-flex align-items-center rounded text-decoration-none" href="#offcanvas">Offcanvas</a>
                    </li>
                    <li>
                        <a class="d-inline-flex align-items-center rounded text-decoration-none" href="#pagination">Pagination</a>
                    </li>
                    <li>
                        <a class="d-inline-flex align-items-center rounded text-decoration-none" href="#placeholders">Placeholders</a>
                    </li>
                    <li>
