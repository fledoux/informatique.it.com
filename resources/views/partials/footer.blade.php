...
<footer class="mt-5 px-5 bg-white footer mt-auto">
    <div
        ...
        <a href="https://yellowcactus.com" target="_blank" class="mb-3 mb-md-0">
            <img src="{{ asset('assets/img/logo/yellowcactus_logo_bw.svg') }}" alt="Yellow Cactus" style="height:24px;"
                class="ms-2">
        </a>
        <div class="small text-secondary mb-3 mb-md-0">©
            {{ date('Y') }},
            <a href="https://yellowcactus.com" target="_blank" class="text-orange">Yellow&nbsp;Cactus</a>.
