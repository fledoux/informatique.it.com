...
class TicketReplyNotificationMail extends Mailable
{
	...
	public function content(): Content
	{
		...
		$content = '<strong>Sujet :</strong> ' . e($this->ticket->subject) . '<br>';
		$content .= '<strong>Client :</strong> ' . e($this->ticket->author->name) . ' (' . e($this->ticket->author->email) . ')<br>';
		$content .= '<strong>Société :</strong> ' . e($this->ticket->company->name);
		...
		// Ajouter le code de réponse pour permettre à l'équipe support de répondre par email
